  ...
  return (
    ...
    <div class="container" className="flex flex-col justify-between h-full item-center">
      ...
      <header id="headerBg" className="sticky top-0 w-full border-b-2 border-black justify-between h-32 mb-5 flex z-10">
       <nav className= "ml-10 justify-start items-center flex">
           <ul className="h-10 w-full flex" class="menu">
              <li className="w-40 h-16 flex"><a id="homeButton" className="flex-center ml-2" href="#">Home</a></li>
              <li className="w-40 h-16 flex"><a id="homeButton" className="flex-center ml-2" href="#">Projects</a></li>
              <li className="w-40 h-16 flex"><a id="homeButton" className="flex-center ml-2" href="#">About</a></li>
           </ul> 
       </nav>
       
        
      </header>
      <main class="main" className=" h-full  items-center">
        <p class="pClass" className=" items-center p-10 z-0 flex justify-center">Welcome here!</p>
        
        <div class="img" className=" mt-6 z-0 flex flex-center justify-between">
      ...
      <footer id="headerBg" className=" border-black bg-white flex-col flex items-center justify-between h-1/6 w-full bottom-0">
        ...
        <a href="#" class="yticon" target="_blank">
